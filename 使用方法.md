...
```sh
python train.py --img 640 --batch-size -1 --workers 8 --epochs 300 --hyp data/hyps/hyp.scratch-low.yaml  --optimizer SGD --cos-lr --device 0 --weights weights/yolov5n.pt --cfg models/yolov5n.yaml --data data/coco128.yaml
python train.py --img 640 --batch-size -1 --workers 8 --epochs 300 --hyp data/hyps/hyp.scratch-low.yaml  --optimizer SGD --cos-lr --device 0 --weights weights/yolov5s.pt --cfg models/yolov5s.yaml --data data/coco128.yaml
python train.py --img 640 --batch-size -1 --workers 8 --epochs 300 --hyp data/hyps/hyp.scratch-high.yaml --optimizer SGD --cos-lr --device 0 --weights weights/yolov5m.pt --cfg models/yolov5m.yaml --data data/coco128.yaml
python train.py --img 640 --batch-size -1 --workers 8 --epochs 300 --hyp data/hyps/hyp.scratch-high.yaml --optimizer SGD --cos-lr --device 0 --weights weights/yolov5l.pt --cfg models/yolov5l.yaml --data data/coco128.yaml
python train.py --img 640 --batch-size -1 --workers 8 --epochs 300 --hyp data/hyps/hyp.scratch-high.yaml --optimizer SGD --cos-lr --device 0 --weights weights/yolov5x.pt --cfg models/yolov5x.yaml --data data/coco128.yaml
```

> `Adam` & `AdamW`

```sh
python train.py --img 640 --batch-size -1 --workers 8 --epochs 300 --hyp data/hyps/hyp.scratch-low-adam.yaml  --optimizer AdamW --cos-lr --device 0 --weights weights/yolov5n.pt --cfg models/yolov5n.yaml --data data/coco128.yaml
python train.py --img 640 --batch-size -1 --workers 8 --epochs 300 --hyp data/hyps/hyp.scratch-low-adam.yaml  --optimizer AdamW --cos-lr --device 0 --weights weights/yolov5s.pt --cfg models/yolov5s.yaml --data data/coco128.yaml
python train.py --img 640 --batch-size -1 --workers 8 --epochs 300 --hyp data/hyps/hyp.scratch-high-adam.yaml --optimizer AdamW --cos-lr --device 0 --weights weights/yolov5m.pt --cfg models/yolov5m.yaml --data data/coco128.yaml
python train.py --img 640 --batch-size -1 --workers 8 --epochs 300 --hyp data/hyps/hyp.scratch-high-adam.yaml --optimizer AdamW --cos-lr --device 0 --weights weights/yolov5l.pt --cfg models/yolov5l.yaml --data data/coco128.yaml
python train.py --img 640 --batch-size -1 --workers 8 --epochs 300 --hyp data/hyps/hyp.scratch-high-adam.yaml --optimizer AdamW --cos-lr --device 0 --weights weights/yolov5x.pt --cfg models/yolov5x.yaml --data data/coco128.yaml
```
...
```sh
python -m torch.distributed.launch --nproc_per_node=8 train.py --device 0,1,2,3,4,5,6,7 --sync-bn --img 640 --batch-size -1 --workers 8--epochs 300 \
...
python detect.py --imgsz 640 --weights weights/yolov5s.fp16.onnx --half --data data/coco128.yaml --source data/images/bus.jpg --device 0				# fp16模型需要 --half
python detect.py --imgsz 640 --weights weights/yolov5s.fp16.onnx --half --data data/coco128.yaml --source ../datasets/coco128/images/train2017 --device 0

python detect.py --imgsz 640 --weights weights/yolov5s.fp16.onnx --half --data data/coco128.yaml --source data/images/bus.jpg --device cpu				# gpu导出的fp16模型可以用cpu推理
python detect.py --imgsz 640 --weights weights/yolov5s.fp16.onnx --half --data data/coco128.yaml --source ../datasets/coco128/images/train2017 --device cpu

python detect.py --imgsz 640 --weights weights/yolov5s.cpu.dynamic.onnx --data data/coco128.yaml --source data/images/bus.jpg --device 0				# 使用cpu导出的dynamic模型可以用gpu推理
python detect.py --imgsz 640 --weights weights/yolov5s.cpu.dynamic.onnx --data data/coco128.yaml --source ../datasets/coco128/images/train2017 --device 0
```
...
```sh
python detect.py --imgsz 640 --weights weights/yolov5s.engine --half --data data/coco128.yaml --source data/images/bus.jpg --device 0					# fp32模型也能用 --half 推理
python detect.py --imgsz 640 --weights weights/yolov5s.engine --half --data data/coco128.yaml --source ../datasets/coco128/images/train2017 --device 0

python detect.py --imgsz 640 --weights weights/yolov5s.fp16.engine --half --data data/coco128.yaml --source data/images/bus.jpg --device 0
python detect.py --imgsz 640 --weights weights/yolov5s.fp16.engine --half --data data/coco128.yaml --source ../datasets/coco128/images/train2017 --device 0

python detect.py --imgsz 640 --weights weights/yolov5s.fp32.dynamic.engine --half --data data/coco128.yaml --source data/images/bus.jpg --device 0		 # fp32模型也能用 --half 推理
python detect.py --imgsz 640 --weights weights/yolov5s.fp32.dynamic.engine --half --data data/coco128.yaml --source ../datasets/coco128/images/train2017 --device 0
```
...
```sh
python val.py --imgsz 640 --save-txt --save-hybrid --save-conf --save-json --weights weights/yolov5s.pt --data data/coco128.yaml --device 0
```

## torchscript

```sh
python val.py --imgsz 640 --save-txt --save-hybrid --save-conf --save-json --weights weights/yolov5s.torchscript --data data/coco128.yaml --device 0
```
...
```sh
python val.py --imgsz 640 --save-txt --save-hybrid --save-conf --save-json --weights weights/yolov5s.onnx --data data/coco128.yaml --device 0

python val.py --imgsz 640 --save-txt --save-hybrid --save-conf --save-json --weights weights/yolov5s.onnx --data data/coco128.yaml --device 0 --dnn
```
...
```sh
python val.py --imgsz 640 --save-txt --save-hybrid --save-conf --save-json --weights weights/yolov5s_openvino_model --data data/coco128.yaml --device cpu
```

## tensorrt

```sh
python val.py --imgsz 640 --save-txt --save-hybrid --save-conf --save-json --weights weights/yolov5s.engine --data data/coco128.yaml --device 0
```
