...
```sh
python export.py --imgsz 640 --weights weights/yolov5s.pt --include onnx --simplify
```

## openvino

```sh
python export.py --imgsz 640 --weights weights/yolov5s.pt --include openvino
```
...
```sh
python export.py --imgsz 640 --weights weights/yolov5s.pt --include engine --device 0 --half
```
