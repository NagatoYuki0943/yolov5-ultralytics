...
```sh
python val.py --imgsz 640 --save-txt --save-conf --save-json --weights weights/yolov5s.pt --data data/coco128.yaml --device 0
```

## torchscript

```sh
python val.py --imgsz 640 --save-txt --save-conf --save-json --weights weights/yolov5s.torchscript --data data/coco128.yaml --device 0
```
...
```sh
python val.py --imgsz 640 --save-txt --save-conf --save-json --weights weights/yolov5s.onnx --data data/coco128.yaml --device 0

python val.py --imgsz 640 --save-txt --save-conf --save-json --weights weights/yolov5s.onnx --data data/coco128.yaml --device 0 --dnn
```
...
```sh
python val.py --imgsz 640 --save-txt --save-conf --save-json --weights weights/yolov5s_openvino_model --data data/coco128.yaml --device cpu
```

## tensorrt

```sh
python val.py --imgsz 640 --save-txt --save-conf --save-json --weights weights/yolov5s.engine --data data/coco128.yaml --device 0
```
