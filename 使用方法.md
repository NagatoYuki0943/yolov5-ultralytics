...
```sh
python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s.pt --source data/images/bus.jpg --device 0

python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s.pt --source ../datasets/coco128/images/train2017 --device 0
```

## torchscript

```sh
python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s.torchscript --source data/images/bus.jpg --device 0

python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s.torchscript --source ../datasets/coco128/images/train2017 --device 0
```
...
```sh
python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s.onnx --source data/images/bus.jpg --device 0
python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s.onnx --source ../datasets/coco128/images/train2017 --device 0

python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s.fp16.onnx --half --source data/images/bus.jpg --device 0				# fp16模型需要 --half
python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s.fp16.onnx --half --source ../datasets/coco128/images/train2017 --device 0

python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s.fp16.onnx --half --source data/images/bus.jpg --device cpu				# gpu导出的fp16模型可以用cpu推理
python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s.fp16.onnx --half --source ../datasets/coco128/images/train2017 --device cpu

python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s.cpu.dynamic.onnx --source data/images/bus.jpg --device 0				# 使用cpu导出的dynamic模型可以用gpu推理
python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s.cpu.dynamic.onnx --source ../datasets/coco128/images/train2017 --device 0
```
...
```sh
python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s_openvino_model --source data/images/bus.jpg --device cpu

python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s_openvino_model --source ../datasets/coco128/images/train2017 --device cpu
```

## tensorrt

```sh
python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s.engine --half --source data/images/bus.jpg --device 0					# fp32模型也能用 --half 推理
python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s.engine --half --source ../datasets/coco128/images/train2017 --device 0

python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s.fp16.engine --half --source data/images/bus.jpg --device 0
python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s.fp16.engine --half --source ../datasets/coco128/images/train2017 --device 0

python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s.fp32.dynamic.engine --half --source data/images/bus.jpg --device 0		 # fp32模型也能用 --half 推理
python detect.py --imgsz 640 --conf-thres 0.25 --iou-thres 0.6 --data data/coco128.yaml --weights weights/yolov5s.fp32.dynamic.engine --half --source ../datasets/coco128/images/train2017 --device 0
```
